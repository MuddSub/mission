...
__all__ = ['BetterConcurrence', 'PreemptException']

class PreemptException(Exception):
	pass


class BetterConcurrence(smach.container.Container):
    ...
    def add(label, state, remapping={}):
        ...
        self = BetterConcurrence._currently_opened_container()
	...
	# Set preempt flag
        #for thread in self._threads.values():
	#	ctype_async_raise(thread, PreemptException)
